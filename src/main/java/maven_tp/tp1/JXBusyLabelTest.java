...
public class JXBusyLabelTest extends JFrame implements ActionListener {
  ...
  Color[] colors =
      {Color.BLACK, Color.WHITE, Color.RED, Color.BLUE, Color.GREEN, Color.GRAY, Color.YELLOW};
  ...
  public JXBusyLabelTest() {
    ...
    String[] colorsName =
        {"Choose a color", "BLACK", "WHITE", "RED", "BLUE", "GREEN", "GRAY", "YELLOW"};
